...
/*
Ideas:
- Sort the order list with asc, then iterate list and check if value of k >= order[i], then it meet the demand, desc value of k, incr value of orders that can meet, ...
*/
